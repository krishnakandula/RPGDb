...
CREATE TABLE ARMOR (
	Armor_id VARCHAR(200) NOT NULL
	,PRIMARY KEY (Armor_id)
);
CREATE TABLE TOOLS (
	Tools_id VARCHAR(200) NOT NULL
	,PRIMARY KEY (Tools_id)
);
CREATE TABLE WEAPONS (
	Weapons_id VARCHAR(200) NOT NULL
	,PRIMARY KEY (Weapons_id)
);
CREATE TABLE BARRACKS (
	Barracks_id VARCHAR(200) NOT NULL
...
CREATE TABLE POTION (
	Potion_id VARCHAR(200) NOT NULL
...
CREATE TABLE CHARACTER_USES_BARRACKS (
	Character_id VARCHAR(200) NOT NULL
	,FOREIGN KEY (Character_id) REFERENCES CHARACTER(Character_id)
	,Barracks_id VARCHAR(200) NOT NULL
	,FOREIGN KEY (BARRACKS_ID) REFERENCES BARRACKS(Barracks_id)
